...
export default function Create() {
  ...
  const [evaluationDimensionDescription, setEvaluationDimensionDescription] = useState("");
  ...
  // const handleCancelRubric = useCallback(async () => {
  //   try {
  //     // setDeleted(true);
  //     await Swal.fire({
          ...
          <>
            ...
            <form onSubmit={onSubmit} action="#" method="POST" className="space-y-1">
              ...
              <div className="grid w-full grid-cols-2 gap-7">
                ...
                <ButtonSecondary text={"Cancelar"} onClick={handleConfirmCancel} />
              </div>
            </form>
          </>)}
      </>
